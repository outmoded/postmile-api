...
module.exports = internals.Db = function (options) {
    ...
    this._client = new MongoDB.Db(options.db, new MongoDB.Server(options.host, options.port, {}), { strict: true });
    this._collections = {};
...
internals.Db.prototype.initialize = function (callback) {
    ...
    this._client.open(function (err, client) {
        ...
        if (!self._username) {
            return self.initCollection(0, callback);
        }

        self._client.authenticate(self._username, self._password, function (err, result) {
...
internals.Db.prototype.initCollection = function (i, callback) {
    ...
    var next = function (err, collection) {
        ...
        self.initCollection(i + 1, callback);
    };
